...
const history = useHistory();
  const PostSample = async (e) => {
    console.log("login button pressed");
    e.preventDefault();
   
        history.push("/enter-haematology-report");
    // }
}
      ...
      <div className="container mt-5">
        <div className="signup-content">
          ...
          <form className="register-form" id="register-form">
            ...
            <div className="form-check">
              <input className="form-check-input" type="checkbox" name="exampleRadios" id="exampleRadios2" value="option3" />
              <label className="form-check-label" for="exampleRadios2">
                Thyroid Profile
              </label>
            </div>
            <button id='search-sample' className="btn btn-outline-success my-2 my-sm-0" type="submit" onClick={PostSample}
