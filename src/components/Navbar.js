  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item dropdown">
        <NavLink className="nav-link dropdown-toggle" to="/signin" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
          Login
          </NavLink>
          <div className="dropdown-menu" aria-labelledby="navbarDropdown">
          <NavLink className="dropdown-item" to="/admin-login">Admin Login</NavLink>
          <NavLink className="dropdown-item" to="/user-login">User Login</NavLink>
          </div>
      </li>
      ...
      <li className="nav-item">
        <NavLink className="nav-link" to="/enter-thyroid-report">EnterThyroidProfileData</NavLink>
      </li>
      <li className="nav-item">
        <NavLink className="nav-link" to="/enter-glucometry-report">EnterGlucometryData</NavLink>
      </li>
      <li className="nav-item">
        <NavLink className="nav-link" to="/stored-hae-report">StoredHaeReport</NavLink>
      </li> */}
    </ul>
